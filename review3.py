...
try:
    ...
    input4 = browser.find_element(By.CSS_SELECTOR, '.second_block .form-group.first_class input')
    input4.send_keys("47895")
    input5 = browser.find_element(By.CSS_SELECTOR, '.second_block .form-group.second_class input')
    input5.send_keys("moskva, kremlin")
